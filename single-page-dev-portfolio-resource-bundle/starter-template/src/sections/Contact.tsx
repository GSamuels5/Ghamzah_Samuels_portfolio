...
export const ContactSection = () => {
  ...
  <div className='py-16 pt-12 lg:py-24 lg:pt-12'>
    ...
    <p className='text-sm md:text-base mt-2'> Do you want me to bring your software ideas to life?
